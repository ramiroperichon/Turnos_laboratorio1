<x-app-layout>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('servicio.store') }}" method="POST">
                            ...
                            <div class="col mt-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="precio" name="precio" placeholder="Ej: 20000" required
                                        class="form-control number-input col-sm-3" />
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control col-lg-6" id="descripcion" placeholder="Ingrese la descripcion del servicio..." required name="descripcion"
                                rows="4"></textarea>
                        ...
                        <div class="form-group row gx-5">
                            ...
                            <div class="col mt-3">
                                ...
                                <input type="time" id="fin_turno" name="fin_turno" min="07:00" value="19:00"
                                    max="20:00" required class="form-control" />
                                ...
                                <div class="btn-group flex-wrap mt-2" role="group"
                                    ...
                                    @foreach (['Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'] as $day)
                                        <input type="checkbox" class="btn-check" value="{{ $day }}"
                                            name="dias_disponible[]" id="btncheck{{ $day }}" autocomplete="off">
    ...
    <script>
        document.querySelector(".number-input").addEventListener("keypress", function(evt) {//evita poder colocar la e y los signos en los input de numeros
